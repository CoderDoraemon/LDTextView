...
CGFloat const kLDTextViewPlaceholderVerticalMargin = 8.0; ///< placeholder垂直方向边距
CGFloat const kLDTextViewPlaceholderHorizontalMargin = 6.0; ///< placeholder水平方向边距

@interface LDTextView ()

@property (nonatomic, copy) LDTextViewHandler changeHandler; ///< 文本改变Block
@property (nonatomic, copy) LDTextViewHandler maxHandler; ///< 达到最大限制字符数Block
...
- (void)initialize {
    ...
    [self addConstraint:[NSLayoutConstraint constraintWithItem:placeholderLabel
                                                     ...
                                                     attribute:NSLayoutAttributeTop
                                                    multiplier:1.0
                                                      constant:kLDTextViewPlaceholderVerticalMargin]];
    [self addConstraint:[NSLayoutConstraint constraintWithItem:placeholderLabel
                                                     ...
                                                     attribute:NSLayoutAttributeLeft
                                                    multiplier:1.0
                                                      constant:kLDTextViewPlaceholderHorizontalMargin]];
    [self addConstraint:[NSLayoutConstraint constraintWithItem:placeholderLabel
                                                     ...
                                                     attribute:NSLayoutAttributeWidth
                                                    multiplier:1.0
                                                      constant:-kLDTextViewPlaceholderHorizontalMargin*2]];
    [self addConstraint:[NSLayoutConstraint constraintWithItem:placeholderLabel
                                                     ...
                                                     attribute:NSLayoutAttributeHeight
                                                    multiplier:1.0
                                                      constant:-kLDTextViewPlaceholderVerticalMargin*2]];
}
...
- (void)addTextDidChangeHandler:(LDTextViewHandler)changeHandler{
